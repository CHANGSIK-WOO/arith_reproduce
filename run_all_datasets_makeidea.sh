...
echo "========================================"
bash shell/run_pacs_makeidea.sh
...
echo "========================================"
bash shell/run_officeh_makeidea.sh
...
echo "========================================"
bash shell/run_vlcs_makeidea.sh
...
echo "========================================"
bash shell/run_terra_makeidea.sh
...
echo "========================================"
bash shell/run_domainnet_makeidea.sh
