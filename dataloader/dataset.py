...
class SingleClassData(Dataset):
    def __init__(self, root_dir, domain, classes, domain_label=-1, classes_label=-1, transform=None,
...
class MultiClassData(Dataset):
    def __init__(self, root_dir, domain, classes, domain_label=-1, get_classes_label=True, class_to_idx=None,
...
class MultiDomainData(Dataset):
    def __init__(self, root_dir, domain, classes, domain_class_dict=None, get_domain_label=False,
                 get_classes_label=True, transform=None, loader=default_loader):
    ...
    def load_dataset(self):
        ...
        for i, domain_name in enumerate(self.domain):
            ...
            if self.domain_class_dict is None:
                ...
                sub_class_to_idx = {the_class: class_to_idx[the_class] for the_class in
                                    self.domain_class_dict[domain_name]}
